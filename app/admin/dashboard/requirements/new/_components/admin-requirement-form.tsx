  ...
  const onSubmit = async (data: JobRequirementFormData) => {
    ...
    try {
      ...
      const result = await createAdminRequirement(freshToken, {
        ...
        developersNeeded: data.developersNeeded,
    ...
    <>
      <div className="flex items-center gap-3">
        <Button variant="ghost" size="icon" className="size-8" asChild>
          <Link href="/admin/dashboard/requirements">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Select the company this requirement belongs to.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-2">
            <Label>Company</Label>
            <Select value={companyId} onValueChange={(v) => { setCompanyId(v); setCompanyError(null); }}>
              <SelectTrigger>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex items-center justify-end gap-3 pt-2">
              <Button variant="outline" asChild>
                <Link href="/admin/dashboard/requirements">Cancel</Link>
              </Button>
