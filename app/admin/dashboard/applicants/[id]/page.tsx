              ...
              <CardContent className="space-y-3">
                ...
                {applicant.phone && (
                  <div className="flex items-center gap-3 text-sm">
                    ...
                    <a
                      href={`https://wa.me/${applicant.phone.replace(/[^0-9]/g, "")}?text=${encodeURIComponent(`Hi ${applicant.fullName?.split(" ")[0] ?? "there"}, this is OctogleHire. We came across your profile and were really impressed — we'd love to take things forward and discuss some exciting opportunities with you. Would you be available for a quick chat?`)}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="ml-1 text-muted-foreground transition-colors hover:text-[#25D366]"
