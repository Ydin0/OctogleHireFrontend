  ...
  return (
    <>
      <HirePageLayout
        ...
        title={`Hire Top Developers in ${country}`}
        titleAccent={country}
        description={`OctogleHire delivers rigorously vetted engineers based in ${country} at 40–60% below US/UK rates. Receive 3–5 matched profiles within 48 hours — compliance across 30+ countries fully managed.`}
        benefits={benefits}
