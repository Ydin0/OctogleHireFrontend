    ...
    if (hasHalfStar) {
      stars.push(
        <div key="rating-half-star" className="relative">
          <StarHalf className="absolute top-0 right-0 fill-pulse stroke-pulse" />
          <StarHalf className="absolute top-0 left-0 -scale-x-100 fill-pulse/15 stroke-pulse/15" />
        </div>,
      );
    }
    ...
    for (let i = 0; i < emptyStars; i++) {
      stars.push(
        <Star
          ...
          className="fill-pulse/15 stroke-pulse/15"
        />,
      );
    }
